  ...
  return (
    <div className="mb-6 px-4 py-3 bg-black dark:bg-gray-800 text-white rounded-md flex flex-col sm:flex-row items-center justify-center sm:justify-between shadow-md">
      ...
      <a
        ...
        target="_blank"
        rel="noopener"
        className="mt-3 px-3 py-2 sm:mt-0 text-xs font-semibold inline-flex items-center text-white hover:text-black bg-gray-700 hover:bg-white rounded shadow-md"
      >
