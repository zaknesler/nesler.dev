...
Vine is a simple PHP micro-framework that I built from scratch, using no other libaries. It was a great learning experience to get into the nitty-gritty of routing, middleware, and the request cycle. It's _not_ something is intended (now or ever) to be production-ready; it is merely a learning experience.
