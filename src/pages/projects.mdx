...
Here are some projects I'm currently working on. Most of them are just for fun. Some served a purpose, and some were just to learn something new.

#### [rcps.io](https://github.com/zaknesler/rcps.io)

Recipe site with an emphasis on minimalism, using the T3 stack.

#### [inty](https://github.com/zaknesler/rust-inty)

Basic interpreter written in Rust with a really lame name.

#### Old projects

Because I lose interest very quickly.
...
Though I don't really want to touch PHP again, these are some fun projects I had worked on using Laravel.
...
- [Socialite Demo](https://github.com/zaknesler/demo-laravel-socialite)
...
- [Stripe Demo](https://github.com/zaknesler/demo-laravel-stripe)
...
I try to maintain template repositories for the libraries I use most often, so I always have a nice starting point for new projects.

- [Next.js](https://github.com/zaknesler/base-next.js)

  Template for Next.js with opinionated config for TypeScript, Tailwind, ESLint, Prettier, and SWR.

- [Express.js](https://github.com/zaknesler/base-express)

  Express.js project with TypeScript, ESLint, Prettier, and Jest.

- [Slim 4](https://github.com/zaknesler/base-slim)

  PHP micro-framework template that is structured like a Laravel app, generally useful for basic PHP projects.
...
These repositories are used to demo how to recreate sites like Google, GitHub, and Reddit using vanilla CSS and Tailwind CSS, along with other design concepts.
